...
#SBATCH --partition=debug #partition - can also specify 'himem' # normal
#SBATCH --ntasks=1 #number of tasks
#SBATCH --mem=1G #memory requested
#SBATCH --output=arr-GAM-Hirundo_rustica.out #STDOUT #DATE #ITER
#SBATCH --error=arr-GAM-Hirundo_rustica.err #STDERR #DATE #ITER
...
Rscript /home/aistrand/Bird_Phenology/Scripts/2-arr-GAM/2-arr-GAM_Copy.R
