...
filename <- paste0("/scratch/aistrand/Bird_Phenology/Data/input_data/ebd_US_states_east_Mississippi_", species,
                   "_0101_0731_complete_zerofilled_grid_cells_relApr-2020_Casey_", years, "_", cells, ".csv")

# filename <- paste0("Bird_Phenology/Data/input_data/ebd_US_states_east_Mississippi_", species, 
#                    "_0101_0731_complete_zerofilled_grid_cells_relApr-2020_Casey_", years, "_", cells, ".csv")
...
ifelse(!dir.exists(paste0("/scratch/aistrand/Bird_Phenology/Figures/GAM/arrival_", RUN_DATE, "_", ITER)),
       dir.create(paste0("/scratch/aistrand/Bird_Phenology/Figures/GAM/arrival_", RUN_DATE, "_", ITER)),
       FALSE)

# ifelse(!dir.exists(paste0("Bird_Phenology/Figures/GAM/arrival_", RUN_DATE, "_", ITER)), 
#        dir.create(paste0("Bird_Phenology/Figures/GAM/arrival_", RUN_DATE, "_", ITER)), 
#        FALSE)
...
setwd(paste0("/scratch/aistrand/Bird_Phenology/Figures/GAM/arrival_", RUN_DATE, "_", ITER))

# setwd(paste0("Bird_Phenology/Figures/GAM/arrival_", RUN_DATE, "_", ITER))
...
setwd("/scratch/aistrand")

# setwd("/Users/alvastrand")

ifelse(!dir.exists(paste0("/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER)),
       dir.create(paste0("/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER)),
       FALSE)

# ifelse(!dir.exists(paste0("Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER)), 
#        dir.create(paste0("Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER)), 
#        FALSE)

ifelse(!dir.exists(paste0("/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER, "/", species)),
       dir.create(paste0("/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER, "/", species)),
       FALSE)

setwd(paste0("/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER, "/", species))

# setwd(paste0("Bird_Phenology/Data/Processed/arrival_GAM_", RUN_DATE, "_", ITER))
...
saveRDS(OUT, file = paste0("arrival_GAM_", scientific_name, "_", years, "_", cells, ".rds"))
