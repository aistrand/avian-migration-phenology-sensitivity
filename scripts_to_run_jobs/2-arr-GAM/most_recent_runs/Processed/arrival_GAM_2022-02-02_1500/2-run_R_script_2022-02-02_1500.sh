...
#SBATCH --ntasks=1 #
#SBATCH --mem=15G # 24G
#SBATCH --output=arr-GAM-Riparia_riparia_180_2019_%J.out # output_files/
#SBATCH --error=arr-GAM-Riparia_riparia_180_2019_%J.err # error_log_files/
#SBATCH --time=24:00:00 #
#SBATCH --job-name=arr-GAM-Riparia_riparia_180_2019 #
