...
#SBATCH --job-name=hm-2022-05-13-Petrochelidon_pyrrhonota
#SBATCH --ntasks=1
#SBATCH --partition=longjobs
#SBATCH --mem=10G
#SBATCH --chdir=/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_IAR_hm_2022-05-13_5000
#SBATCH --output=Petrochelidon_pyrrhonota-iar-hm_%J.out
#SBATCH --error=Petrochelidon_pyrrhonota-iar-hm_%J.err
