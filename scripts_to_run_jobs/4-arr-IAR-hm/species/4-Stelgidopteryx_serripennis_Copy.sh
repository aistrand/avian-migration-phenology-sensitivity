...
#SBATCH --job-name=hm-2022-05-13-Stelgidopteryx_serripennis
#SBATCH --ntasks=1
#SBATCH --partition=longjobs
#SBATCH --mem=10G
#SBATCH --chdir=/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_IAR_hm_2022-05-13_5000
#SBATCH --output=Stelgidopteryx_serripennis-iar-hm_%J.out
#SBATCH --error=Stelgidopteryx_serripennis-iar-hm_%J.err
