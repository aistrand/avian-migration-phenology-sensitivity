...
#SBATCH --job-name=hm-2022-05-13-Antrostomus_carolinensis
#SBATCH --ntasks=1
#SBATCH --partition=longjobs
#SBATCH --mem=10G
#SBATCH --chdir=/scratch/aistrand/Bird_Phenology/Data/Processed/arrival_IAR_hm_2022-05-13_5000
#SBATCH --output=Antrostomus_carolinensis-iar-hm_%J.out
#SBATCH --error=Antrostomus_carolinensis-iar-hm_%J.err
